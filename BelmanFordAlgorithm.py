...
# Bellman ford will go through every edge in V-1 iteration and calculate shortest paths along the way
# It can detect negative cycles afterwards in contrast to Dijkstra
# Running time is O(v*e) so it is used when Dijkstra fails
...
# this function will detect cycles in the graph if there is any
...
if __name__ == '__main__':
    ...
    edges = (edge12, edge11, edge3, edge4, edge5, edge6, edge7, edge8, edge9, edge10, edge1, edge2)
